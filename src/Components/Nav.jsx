  ...
  return (
    <div className='fixed z-[100] w-screen h-14 bg-purple-300/20 backdrop-blur-sm flex justify-between xl:justify-around lg:justify-around items-center px-4 md:px-8 lg:px-16'>
      ...
      <ul className='hidden md:flex flex-row font-roboto gap-4 md:gap-6 lg:gap-8 text-sm md:text-base text-text'>
        ...
        <li className='cursor-pointer'>
          <ScrollLink to="portfolio-section" smooth={true} duration={500}>
            Portfolio
          </ScrollLink>
        </li>
        <li className='cursor-pointer'>
      ...
      {isMenuOpen && (
        <ul className='absolute top-16 left-0 w-full bg-white flex flex-col items-center gap-4 py-4 font-roboto text-sm text-text shadow-lg md:hidden'>
          <li className='cursor-pointer'>
            <ScrollLink to="home-section" smooth={true} duration={500} onClick={() => setIsMenuOpen(false)}>
              Home
            </ScrollLink>
          </li>
          <li className='cursor-pointer'>
            <ScrollLink to="about-section" smooth={true} duration={500} onClick={() => setIsMenuOpen(false)}>
              About
            </ScrollLink>
          </li>
          <li className='cursor-pointer'>
            <ScrollLink to="portfolio-section" smooth={true} duration={500} onClick={() => setIsMenuOpen(false)}>
              Portfolio
            </ScrollLink>
          </li>
          <li className='cursor-pointer'>
            <ScrollLink to="contact-section" smooth={true} duration={500} onClick={() => setIsMenuOpen(false)}>
              Contact
            </ScrollLink>
          </li>
        </ul>
