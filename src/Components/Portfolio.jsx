...
import PROJECT1FULL from '../assets/PROJECT1FUll.png';
import Ecommerce from '../assets/Ecommerce.png';
import ECOMMERCEFULL from '../assets/ECOMMERCEFULL.png';
...
const Portfolio = () => {
  ...
  const portfolioData = [
    {
      id: 1,
      img: Project1, // Replace with your image URL
      fullImg: PROJECT1FULL,
    ...
    },
    {
      id: 2,
      img: Ecommerce,
      fullImg: ECOMMERCEFULL,
      heading: "Modern User-friendly Ecommerce Website",
      shortPara: "",
      link: "/",
      ...
      <div>
        <div className="py-16 Carts w-full h-3/4 mt-1 flex-col xl:flex-row lg:flex-row flex justify-center items-center gap-5 relative">
          {portfolioData.map((Data) => (
            <div
              key={Data.id}
              className="w-[90%] lg:w-[21rem] cart h-96 bg-white/10 rounded-3xl relative backdrop-blur-xl flex justify-between flex-col"
            >
              {Data.img ? (
                <img
              ...
              <div>
                ...
                <p className=" absolute top-64 text-xs lg:text-sm xl:text-sm font-roboto text-white opacity-80 ml-5">
                  {Data.shortPara}
                </p>
                {Data.link ? (
                  <Button
