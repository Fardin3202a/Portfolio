...
const Contact = () => {
  ...
  return (
    <div
    id="contact-section"
    className="flex xl:flex-row lg:flex-row flex-col w-screen xl:w-screen lg:w-screen z-50">
      ...
      <div className="right py-10 w-full lg:w-1/2 xl:w-1/2 h-screen bg-gradient-to-tl from-Secondary to-Primary flex justify-center items-center">
        <form
          onSubmit={onSubmit}
